...
def run():
    ...
    # config
    config = yaml.load(open("./config/envs_gm.yml", 'r'), Loader=yaml.SafeLoader)
    ...
    # plot
    utils.plot_gm_classification(result, \
        file_name=os.path.join(result_dir, "gm_classification" + datetime.today().strftime("%Y%m%d%H%M")) + ".png")
