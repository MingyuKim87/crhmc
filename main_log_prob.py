...
def run():
    ...
    # config
    config = yaml.load(open("./config/envs.yml", 'r'), Loader=yaml.SafeLoader)
    ...
    # plot
    utils.plot_samples(sampled_params, os.path.join(result_dir, "result_coords" + datetime.today().strftime("%Y%m%d%H%M")) + ".png")
    utils.plot_samples(sampled_params, os.path.join(result_dir, "result_coords_lim" + datetime.today().strftime("%Y%m%d%H%M")) + ".png", is_coord_lim = True)
